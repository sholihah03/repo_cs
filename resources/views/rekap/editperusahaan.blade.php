        ...
        <div class="relative flex flex-col min-w-0 break-words bg-transparent border-0 shadow-none rounded-2xl bg-clip-border">
          ...
          <div class="flex-auto p-6">
            <form action="{{ route('rekapPerusahaan.store') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-4">
                  <input type="text" name="nama_perusahaan" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Nama Perusahaan" />
              </div>
              <label class="mb-2 ml-1 font-bold text-xs text-slate-700">Nama Direktur</label>
              <div class="mb-4">
                  <input type="text" name="nama_direktur" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Nama Direktur" />
              </div>
