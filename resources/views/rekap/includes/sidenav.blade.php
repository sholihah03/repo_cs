    ...
    <div class="items-center block w-screen h-screen max-h-screen max-w-screen overflow-auto grow basis-full m-0 p-0">
      <ul class="flex flex-col pl-0 mb-0">
        <li class="mt-0.5 w-full">
          <a class="menu-item py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors" href="{{ route ('dashboardcs') }}">
