        ...
        <section class="py-10 md:py-16">
            ...
            <div class="container max-w-screen-xl mx-auto px-4">
                ...
                <nav class="flex items-center justify-between mb-40">
                    <img src="{{ asset('Porto/Porto/assets/image/navbar-logo.png') }}" alt="Image">
        ...
        <section class="py-10 md:py-16">
            ...
            <div class="container max-w-screen-xl mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    <img src="{{ asset('Porto/Porto/assets/image/brand-1.png') }}">
                    <img src="{{ asset('Porto/Porto/assets/image/brand-2.png') }}">
                    <img src="{{ asset('Porto/Porto/assets/image/brand-3.png') }}">
                    <img src="{{ asset('Porto/Porto/assets/image/brand-4.png') }}">
                    <img src="{{ asset('Porto/Porto/assets/image/brand-5.png') }}">
                    <img src="{{ asset('Porto/Porto/assets/image/brand-6.png') }}">
                </div>
