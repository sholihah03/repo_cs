...
<html>
  <head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('soft/bulid/assets/img/apple-icon.png')}}">
        <link rel="icon" type="image/png" href="{{ asset('soft/bulid/assets/img/favicon.png') }}">
        ...
        <!-- Nucleo Icons -->
        <link href="{{ asset('soft/bulid/assets/css/nucleo-icons.css')}}" rel="stylesheet" />
        <link href="{{ asset('soft/bulid/assets/css/nucleo-svg.css') }}" rel="stylesheet" />
        <!-- Popper -->
        <script src="https://unpkg.com/@popperjs/core@2"></script>
        <!-- Main Styling -->
        <link href="{{ asset('soft/bulid/assets/css/soft-ui-dashboard-tailwind.css') }}" rel="stylesheet" />    
