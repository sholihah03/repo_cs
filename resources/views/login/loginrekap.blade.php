            ...
            <div class="flex flex-wrap mt-0 -mx-3">
                        ...
                        <div class="flex-auto p-5">
                            ...
                            <form role="form" method="POST" action="{{ route('loginrekap') }}">
                                ...
                                <div class="mt-4">
                                    ...
                                    <option value="direktur-login">Direktur</option>
                                    <option value="manager-login">Manager</option>
                                    <option value="karyawan-login">Karyawan</option>
                                    <option value="cs-login">Customer Service</option>
                                    <option value="advertiser-login">Advertiser</option>
                                    </select>
                                </div>
                ...
                <div class="w-full max-w-full px-3 lg:flex-0 shrink-0 md:w-6/12">
                    <div class="absolute top-0 hidden w-3/5 h-full -mr-32 overflow-hidden -skew-x-10 -right-40 rounded-bl-xl md:block">
                        <div class="absolute inset-x-0 top-0 z-0 h-full -ml-16 bg-cover skew-x-10" style="background-image: url('{{ asset('soft/build/assets/img/curved-images/curved6.jpg') }}');"></div>
                    </div>
                </div>
            </div>
        </div>
